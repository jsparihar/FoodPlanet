...
public class ViewAllOrderFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtOrder.setFont(new java.awt.Font("Bell MT", 0, 14)); // NOI18N
        jtOrder.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "ORDID", "PRODUCTID", "QAUNTITY", "COST"
            }
        ));
...
private void ShowDataInTable() 
    {
        try
        {
            ArrayList<OrderDetails>orderList=OrderDetailsDao.getAllData();
            if(orderList.isEmpty())
        {
            JOptionPane.showMessageDialog(null,"Invalid order Id!","Wrong OrderId!",JOptionPane.ERROR_MESSAGE);
            return;
        }
        else
        {
